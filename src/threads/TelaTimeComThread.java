...
public class TelaTimeComThread extends javax.swing.JFrame {

    public TelaTimeComThread() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaTimeComThread.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaTimeComThread().setVisible(true);
            }
        });
    }
